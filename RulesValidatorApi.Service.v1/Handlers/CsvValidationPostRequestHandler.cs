...
{
    public class CsvValidationPostRequestHandler : IRequestHandler<CsvValidationPostRequestCommand, IEnumerable<CsvValidationPostErrorResponse>>
    {
        ...
        public async Task<IEnumerable<CsvValidationPostErrorResponse>> Handle(CsvValidationPostRequestCommand request, CancellationToken cancellationToken)
        {
